...
Upgrading the package does **not** refresh a runtime you already have — the
bundle is a separate download cached outside site-packages. When a release
ships against a newer Nereus, `session()` says so on start-up; get it with:
